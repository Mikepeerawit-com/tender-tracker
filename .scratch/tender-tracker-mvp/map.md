...
- **Tender ownership: single owner or shared.** `owner_user_id` is singular; real purchasing work is often shared. Touches notification targeting (08) and the dashboard's "my tenders" framing, if any.
- **Timezone handling.** Users in different countries, deadlines as dates, a daily cron. There's a correctness question here but it can't be phrased sharply until 08 and 10 settle what a "day" means for reminders and metrics.
